...
<?php
	...
	echo '<tr><td>Date Posted:'.$row['postDate'].'<br></td></tr>';
	echo '<tr><td>Blog Title:<a href="viewpost.php?id='.$row['id'].'">'.$row['blogTitle'].'</a><br></td></tr>';
	echo '<tr><td>Blog Post:'.$row['blogPost'].'</td></tr><br><br><br>';
	echo '</table>';
	}
